...
echo $chck2.Location = New-Object Drawing.Point 0,5; 
echo $chck2.Size = New-Object Drawing.Point 270,25; 
echo $chck2.Text = 'Disable Telemetry Scheduled Tasks'; 
echo $chck2.TabIndex = 30; 
echo $chck2.Checked = $true; 
echo $chck2.Font = $Font;
echo $panel2.controls.add^($chck2^); 
echo $chck2.add_click^({count_s}^)

echo $chck3 = New-Object Windows.Forms.Checkbox; 
echo $chck3.Location = New-Object Drawing.Point 0,5; 
echo $chck3.Size = New-Object Drawing.Point 270,25; 
echo $chck3.Text = 'Show File Extensions in Explorer'; 
echo $chck3.TabIndex = 47; 
echo $chck3.Checked = $true; 
echo $chck3.Font = $Font;
echo $panel3.controls.add^($chck3^); 
echo $chck3.add_click^({count_v}^)

echo $chck4 = New-Object Windows.Forms.Checkbox; 
echo $chck4.Location = New-Object Drawing.Point 0,05; 
echo $chck4.Size = New-Object Drawing.Point 250,25; 
echo $chck4.Text = 'Remove Windows Game Bar/DVR'; 
echo $chck4.TabIndex = 53; 
echo $chck4.Checked = $true; 
echo $chck4.Font = $Font;
echo $panel4.controls.add^($chck4^);  
echo $chck4.add_click^({count_o}^)

echo $chck5 = New-Object Windows.Forms.Checkbox; 
echo $chck5.Location = New-Object Drawing.Point 10,50; 
echo $chck5.Size = New-Object Drawing.Point 270,25; 
echo $chck5.Text = 'Disable Xbox Services'; 
echo $chck5.TabIndex = 60; 
echo $chck5.Checked = $false;
echo $chck5.ForeColor = [System.Drawing.ColorTranslator]::FromHtml^($expercolor^) 
echo $chck5.Font = $Font;
echo $groupBox5.controls.add^($chck5^); 
